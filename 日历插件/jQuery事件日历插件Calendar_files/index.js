...
function($) {
  ...
  TEMPLATE = ['<div class="calendar-inner">',
                '<div class="calendar-views">', 
                  '<div class="view view-date">',
                    '<div class="calendar-hd">',
                      '<a href="" data-calendar-display-date class="calendar-display">',
  ...
  Calendar.prototype = {
      ...
      getDaysHtml: function(y, m) {
          var year, month, firstWeek, daysNum, prevM, prevDiff, dt = this.date,
      ...
      event: function() {
          ...
          _this.$element.on('click', DISPLAY_VD,
          function() {
          ...
          _this.$element.on('click', ARROW_DATE,
          function() {
              var arr = _this.getDisDateValue(),
              type = getClass(this),
              y = arr[0],
          ...
          _this.$element.on('click', '[' + ITEM_DAY + ']',
          function() {
          ...
          _this.$element.on('mouseenter', '[' + ITEM_DAY + ']',
          function(e) {
              var arr = _this.getDisDateValue(),
